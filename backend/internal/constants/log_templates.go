...
const (
	...
	LogCaseAssignConflict      = "case assign rejected: lawyer conflict of interest"
	LogCaseAssignCheckSkipped  = "case assign conflict check skipped: opponent info missing"
